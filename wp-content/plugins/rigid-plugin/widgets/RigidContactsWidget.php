 ...
 * @author aatanasov
 */
class RigidContactsWidget extends WP_Widget {

	public function __construct() {
		$widget_ops = array('description' => esc_html__('Shows contact details', 'rigid-plugin'));
		parent::__construct('rigid_contacts_widget', 'Rigid Contacts details', $widget_ops);
	}
	...
	public function form($instance) {
		// Defaults
		$defaults = array(
				'title' => esc_html__('Have a Question?', 'rigid-plugin'),
				'worktime' => '',
				'address' => '',
				'phone' => '',
				'fax' => '',
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('worktime')); ?>"><?php esc_html_e('Store working time:', 'rigid-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address:', 'rigid-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone number:', 'rigid-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php esc_html_e('Fax number:', 'rigid-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email address:', 'rigid-plugin'); ?></label>
...
add_action('widgets_init', 'rigid_register_rigid_contacts_widget');
if (!function_exists('rigid_register_rigid_contacts_widget')) {

	function rigid_register_rigid_contacts_widget() {
		register_widget('RigidContactsWidget');
	}
