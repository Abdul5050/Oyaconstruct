...
if (!class_exists('RigidShortcodeVendorList')) {

    class RigidShortcodeVendorList {
        /**
         * Filter vendor list
         * @global object $WCMp
        ...
        public static function output($atts) {
            global $WCMp;
            extract(shortcode_atts(array('orderby' => 'registered', 'order' => 'ASC', 'limit' => '', 'hide_order_by' => ''), $atts, 'rigid_wcmp_vendorslist'));
	        $selected_category = '';
	        $sort_type = $orderby;
