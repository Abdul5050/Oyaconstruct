...
final class Rigid_WC_Variation_Swatches {
	/**
	 * The single instance of the class
	 *
	 * @var Rigid_WC_Variation_Swatches
	 */
	 ...
	 * Main instance
	 *
	 * @return Rigid_WC_Variation_Swatches
	 */
	...
	public function __construct() {
		$this->types = array(
			'color' => esc_html__( 'Color', 'rigid-plugin' ),
			'image' => esc_html__( 'Image', 'rigid-plugin' ),
			'label' => esc_html__( 'Label', 'rigid-plugin' ),
		);
	...
	public function init_hooks() {
		...
		if ( is_admin() ) {
			add_action( 'init', array( 'Rigid_WC_Variation_Swatches_Admin', 'instance' ) );
		} else {
			add_action( 'init', array( 'Rigid_WC_Variation_Swatches_Frontend', 'instance' ) );
		}
	}
	...
	public function admin() {
		return Rigid_WC_Variation_Swatches_Admin::instance();
	}
	...
	public function frontend() {
		return Rigid_WC_Variation_Swatches_Frontend::instance();
	}
}
 ...
 */
function Rigid_WCVS() {
	return Rigid_WC_Variation_Swatches::instance();
}
 ...
 */
function rigid_wc_variation_swatches_constructor() {
