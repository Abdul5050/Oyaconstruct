...
(function ($) {
    ...
    rigid_optionsframeworkMLU = {
        ...
        mediaUpload: function () {
            ...
            //$('input.rigid_upload_button').removeAttr('style');
            ...
            var formfield,
                ...
                tbframe_interval;
            // On Click
            $('input.rigid_upload_button').on("click", function (e) {
    ...
    }; // End rigid_optionsframeworkMLU Object // Don't remove this, or the sky will fall on your head.

    /*-----------------------------------------------------------------------------------*/
    /* Execute the above methods in the rigid_optionsframeworkMLU object.
     /*-----------------------------------------------------------------------------------*/

    $(document).ready(function () {

        rigid_optionsframeworkMLU.removeFile();
        rigid_optionsframeworkMLU.recreateFileField();
        rigid_optionsframeworkMLU.mediaUpload();
