jQuery(document).ready(function () {
	"use strict";
	var google_fonts_defined_json = rigid_font_prev_params.fonts.replace(/&quot;/g, '"');
	var google_fonts_defined = jQuery.parseJSON(google_fonts_defined_json);

	// For the live fonts setup preview
	jQuery('#body_font_size,#body_font_face,#body_font_color').change(function () {
		if (!google_fonts_defined.hasOwnProperty(jQuery('#body_font_face').val())) {
			jQuery("[id^='rigid_ogfB_']").remove();
			jQuery('head').append('<link id="rigid_ogfB_' + jQuery('#body_font_face').val() + '" rel="stylesheet" href="//fonts.googleapis.com/css?family=' + jQuery('#body_font_face').val() + ':100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic&subset=' + rigid_font_prev_params.google_subset + '">@font-face {font-family: "' + jQuery('#body_font_face option:selected').text() + '";}</link>');
		}
		jQuery('#body_font_preview').html('<p style="font-family:' + jQuery('#body_font_face option:selected').text() + ';font-size:' + jQuery('#body_font_size').val() + ';color:' + jQuery('#body_font_color').val() + '">Sample Text</p>');
	...
	jQuery('#headings_font_face').change(function () {
		if (!google_fonts_defined.hasOwnProperty(jQuery('#headings_font_face').val())) {
			jQuery("[id^='rigid_ogfH_']").remove();
			jQuery('head').append('<link id="rigid_ogfH_' + jQuery('#headings_font_face').val() + '" rel="stylesheet" href="//fonts.googleapis.com/css?family=' + jQuery('#headings_font_face').val() + ':100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic&subset=' + rigid_font_prev_params.google_subset + '">@font-face {font-family: "' + jQuery('#headings_font_face option:selected').text() + '";}</link>');
		}
	...
	jQuery('#h1_font_size,#h1_font_color,#h1_font_style').change(function () {
	...
	jQuery('#h2_font_size,#h2_font_color,#h2_font_style').change(function () {
	...
	jQuery('#h3_font_size,#h3_font_color,#h3_font_style').change(function () {
	...
	jQuery('#h4_font_size,#h4_font_color,#h4_font_style').change(function () {
	...
	jQuery('#h5_font_size,#h5_font_color,#h5_font_style').change(function () {
	...
	jQuery('#h6_font_size,#h6_font_color,#h6_font_style').change(function () {
