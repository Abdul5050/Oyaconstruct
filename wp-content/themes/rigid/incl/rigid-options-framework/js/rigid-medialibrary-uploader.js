...
(function ($) {
    $(document).ready(function () {
        ...
        jQuery('.rigid_upload_image_button').on('click', function (event) {
            ...
            file_frame.on('select', function () {
                ...
                selection.map(function (attachment) {
                    ...
                    else if (optionId === 'rigid_super_slider_ids' && attachment.sizes.rigid_general_small_size) {
                        jQuery('#' + optionId + '_images').append('<img alt="" src="' + attachment.sizes.rigid_general_small_size.url + '">');
                    }
                    else if (attachment.sizes.rigid_general_medium_size) {
                        jQuery('#' + optionId + '_images').append('<img alt="" src="' + attachment.sizes.rigid_general_medium_size.url + '">');
                    }
                    else {
                        jQuery('#' + optionId + '_images').append('<img alt="" src="' + attachment.url + '">');
                    }
        ...
        jQuery('a.rigid_remove_image_link').on('click', function (event) {
        ...
        /**
         * Delete an rigid featured image
         */
        jQuery('.rigid_delete_image_button').on('click', function (event) {
        ...
        jQuery('#add_custom_sidebar').on('click', function (event) {
            ...
            if ($.trim(newSdbr) !== '') {
                ...
                if (currentSdbrs.search($.trim(newSdbr)) === -1) {
                    ...
                    jQuery('#rigid_custom_sidebars_list').append(
                        '<div><a class="rigid_del_sdbr" data-sidebar-name="' + newSdbr + '" href="#"></a>' + newSdbr + '</div>'
                    );
                }
                else {
                ...
                if ($.trim($('#sidebar_ids').val()) !== '') {
                    $('.rigid_no_custom_sidebars').html('List of created custom sidebars:');
                }
            }
        });
         ...
         * Delete sidebar
         */
        $('#rigid_custom_sidebars_list').delegate('.rigid_del_sdbr', 'click', function (event) {
            event.preventDefault();
